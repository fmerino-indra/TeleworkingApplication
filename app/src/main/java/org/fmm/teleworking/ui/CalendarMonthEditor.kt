...
private fun DayCell(
    ...
    // Determine color
    val bg = when {
        dto?.festive == true -> colorResource(COLOR_FESTIVE)
        date.dayOfWeek == DayOfWeek.SATURDAY || date.dayOfWeek == DayOfWeek.SUNDAY ->
            colorResource(COLOR_WEEKEND)
        dto?.modality == Modality.TELEWORK -> colorResource(COLOR_TELEWORK)
        dto?.modality == Modality.PRESENTIAL -> colorResource(COLOR_PRESENTIAL)
